...
class Emp implements Comparable<Emp>{
    ...
    public Emp(int id, double salary, int month, int year, String name, String cmpName) {
        this.id = id;
        this.salary = salary;
        this.month = month;
        this.year=year;
    ...
    public static Comparator<Emp> SalaryAscending=new Comparator<Emp>() {
        @Override
    ...
    public  static Comparator<Emp> SalaryDescending=new Comparator<Emp>() {
        @Override
        public int compare(Emp t1, Emp t2) {
...
public class ArraylistTask {
    public static void main(String[] args) {
        ...
        emp.add(new Emp(120, 30000, 01, 2023,"Amit Gupta", "Technosoft Pvt"));
        emp.add(new Emp(121, 20000, 02, 2023,"Karan Tiwari", "Racl GearTech"));
        emp.add(new Emp(122, 40000, 06, 2023,"Prashant Sharma", "RedTape pvt"));
        emp.add(new Emp(123, 25000, 07, 2023,"Sumit Jain", "RedDoorz tech"));
        emp.add(new Emp(124, 50000, 03, 2023,"Rani G", "Technosoft Pvt"));
        ...
        Collections.sort(emp, Emp.SalaryAscending);
        System.out.println("\nSorting by Salary (Ascending Order): ");
        for (Emp e:emp){
            System.out.println(e.getName()+" : "+e.getSalary());
        }
        // Sorting by Salary (Descending)
        Collections.sort(emp, Emp.SalaryDescending);
